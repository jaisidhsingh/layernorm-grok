...
for seed in $seeds; do
    for os in $scalings; do
        python3 -m experiments.train_transformer \
            --exp.name wrng_trf-1l_lecun_none_os-${os}_seed-$seed \
...
for seed in $seeds; do
    for os in $scalings; do
        python3 -m experiments.train_transformer \
            --exp.name eps0_wrng_trf-1l_kaiming_none_os-${os}_seed-$seed \
            --exp.project your-wandb-project \
            --exp.seed $seed \
            --data.seed $seed \
            --model.seed $seed \
...
for seed in $seeds; do
    for os in $scalings; do
        python3 -m experiments.train_transformer \
            --exp.name subtr_wrng_trf-1l_lecun_none_os-${os}_seed-$seed \
            --exp.project your-wandb-project \
            --exp.seed $seed \
            --data.seed $seed \
            --model.seed $seed \
